...
const QUOTES = [
    {
        text: "Collaborate with researchers worldwide to accelerate open-source science and peer review.",
        author: "Dr. Elena Rostova",
        role: "Director of Cognitive Systems Lab"
    },
    {
        text: "Access a decentralized citation ledger designed for verified publication tracking and research discovery.",
        author: "Professor Marcus Vance",
        role: "Department of Quantum Computing"
    },
    {
        text: "Share interactive figures, datasets, and publications in a unified dashboard designed for modern science.",
